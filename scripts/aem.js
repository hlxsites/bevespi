...
/**
 * Decorates all known anchors in a container element and applies associated class
 * @param {Element} [section] Section element where the anchors are defined
 */
function decorateAnchors(section) {
  const knownAnchors = [
    {
      id: 'back-to-top',
      name: 'Back to top',
